...
public class CookieClicker {
	...
	public static void main(String[] args) throws IOException {
		BufferedReader reader = new BufferedReader(new FileReader("io/14/qual/B-large.bin"));
		BufferedWriter writer = new BufferedWriter(new FileWriter("io/14/qual/B-large.out"));
